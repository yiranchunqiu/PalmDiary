package com.pxz.zhangshangriji.view;
...
public class SemicircleProgressView extends View {
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        radius = width / 2;
        mMiddleRect = new RectF((maxWidth / 2) - radius, (maxHeight / 2) - radius, (maxWidth / 2) + radius, (maxHeight / 2) + radius);
        mMiddleProgressRect = new RectF((maxWidth / 2) - radius, (maxHeight / 2) - radius, (maxWidth / 2) + radius, (maxHeight / 2) + radius);
    }
